class MedicamentosController < ApplicationController
  ...
  def index
    @medicamentos = Medicamento.paginate page: params[:page]
  end
  ...
  private
    ...
    def medicamento_params
      params.require(:medicamento).permit(:NU_REGISTRO, :CO_GGREM, :CO_EAN, :NO_PRODUTO, :TP_PRODUTO, :TP_LCCT, :ST_REST_HOSP, :ST_CAP, :ST_CONFAZ87, :NU_PF0_INTEIRO, :NU_PF18_INTEIRO)
    end
end
