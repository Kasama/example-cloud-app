...
class ReceitasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receita" do
    assert_difference('Receita.count') do
      post receitas_url, params: { receita: { DATA: @receita.DATA, DESCRICAO: @receita.DESCRICAO, prontidao: @receita.prontidao } }
    end
  ...
  test "should update receita" do
    patch receita_url(@receita), params: { receita: { DATA: @receita.DATA, DESCRICAO: @receita.DESCRICAO, prontidao: @receita.prontidao } }
