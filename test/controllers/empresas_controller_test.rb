...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { NO_RAZAO_SOCIAL: @empresa.NO_RAZAO_SOCIAL, NU_CNPJ: @empresa.NU_CNPJ } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { NO_RAZAO_SOCIAL: @empresa.NO_RAZAO_SOCIAL, NU_CNPJ: @empresa.NU_CNPJ } }
