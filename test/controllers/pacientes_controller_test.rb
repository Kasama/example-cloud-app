...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { CPF: @paciente.CPF, ENDERECO: @paciente.ENDERECO, NOME: @paciente.NOME } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { CPF: @paciente.CPF, ENDERECO: @paciente.ENDERECO, NOME: @paciente.NOME } }
