...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { CPF: @medico.CPF, CRM: @medico.CRM, ENDERECO: @medico.ENDERECO, NOME: @medico.NOME } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { CPF: @medico.CPF, CRM: @medico.CRM, ENDERECO: @medico.ENDERECO, NOME: @medico.NOME } }
